...
urlpatterns = [
    ...
    path('stock_otions/', stock_options_data, name= 'stock_otions'),
#MOSL - Authentication
...
#Navbar URLS
    ...
    path('option_store/', option_store, name='option_store'),
    path('MutualFund/', MutualFund, name='MutualFund'),

    path('fnoanalytics/', fnoanalytics, name='fnoanalytics'),
    path('help_me_invest/', help_me_invest, name='help_me_invest'),
]
